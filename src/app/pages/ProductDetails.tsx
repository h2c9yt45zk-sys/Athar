...
export const ProductDetails: React.FC = () => {
  ...
  useEffect(() => {
    if (!relatedScrollRef.current || relatedProducts.length === 0) return;
  ...
  return (
    <main className="min-h-screen bg-[#4A0E17] pt-24 pb-section-gap text-[#D4AF37]">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop w-full">
        ...
        {/* ── Main two-column row: image + info ── */}
        <div className="grid grid-cols-1 md:grid-cols-12 md:items-start gap-gutter">
          ...
          <div className="md:col-span-5 lg:col-span-4 flex flex-col justify-center gap-8 w-full pt-4 md:pt-6">
        ...
        {/* ── Related Products — full width below the main grid ── */}
              ...
              {relatedProducts.map((item, index) => {
                ...
                return (
                  <button
                    ...
                    className="group block min-w-[150px] max-w-[150px] overflow-hidden rounded-[18px] border border-[#D4AF37]/20 bg-[#FCF3E9] text-left shadow-sm opacity-100 transition duration-300 hover:-translate-y-1 hover:border-[#D4AF37]/40"
                  >
